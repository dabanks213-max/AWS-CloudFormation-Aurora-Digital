...
> **Cost Note:** Application Load Balancers are **not free tier eligible**. Cost is approximately
> cost is roughly $16/month** at minimal traffic.
...
| No WAF on ALB | Medium — vulnerable to web attacks | Attach AWS WAF to the ALB (not free-tier) |
